...
CREATE TABLE games (
  ...
  p1_total_units INT DEFAULT 10, -- does not count units in the bank
  p2_total_units INT DEFAULT 10, -- does not count units in the bank
  ...
  p1_swordsmen_bank INT DEFAULT 0, -- units currently in the bank only
  p1_archers_bank INT DEFAULT 0, -- units currently in the bank only
  p1_knights_bank INT DEFAULT 0, -- units currently in the bank only
